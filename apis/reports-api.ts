...
export const ReportsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        postReport: async (body: Report, authorization: string, cFTurnstileProof: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
...
export const ReportsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async postReport(body: Report, authorization: string, cFTurnstileProof: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<Report>>> {
            const localVarAxiosArgs = await ReportsApiAxiosParamCreator(configuration).postReport(body, authorization, cFTurnstileProof, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const ReportsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        async postReport(body: Report, authorization: string, cFTurnstileProof: string, options?: AxiosRequestConfig): Promise<AxiosResponse<Report>> {
            return ReportsApiFp(configuration).postReport(body, authorization, cFTurnstileProof, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class ReportsApi extends BaseAPI {
     ...
     * @memberof ReportsApi
     */
    public async postReport(body: Report, authorization: string, cFTurnstileProof: string, options?: AxiosRequestConfig) : Promise<AxiosResponse<Report>> {
        return ReportsApiFp(this.configuration).postReport(body, authorization, cFTurnstileProof, options).then((request) => request(this.axios, this.basePath));
    }
}
