...
import { PostReportParams } from '../models';
...
export const ReportsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {PostReportParams} body 
         * @param {string} authorization 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        postReport: async (body: PostReportParams, authorization: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
...
export const ReportsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async postReport(body: PostReportParams, authorization: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<Report>>> {
...
export const ReportsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        async postReport(body: PostReportParams, authorization: string, options?: AxiosRequestConfig): Promise<AxiosResponse<Report>> {
...
export class ReportsApi extends BaseAPI {
     ...
     * @memberof ReportsApi
     */
    public async postReport(body: PostReportParams, authorization: string, options?: AxiosRequestConfig) : Promise<AxiosResponse<Report>> {
